...
public class RoomWithToString 
{
    ...
    public String toString()
    {
        if (roomStatus)
        {
            return "Room " + roomNumber + " Booking Qty: " + roomBookQuantity + " [Available]";
        }
        return "Room " + roomNumber + " Booking Qty: " + roomBookQuantity + " [Unvailable]";
    }
