...
//EDIT GUEST pane
    ...
    public Button btnReturn = new Button("Return to Employee Menu");
...
//EDIT GUEST PASS tab
    ...
    public Label lblPassChangeSuccessful = new Label("Password Change Successful!");
    public Label lblPassError1 = new Label("Password Must Contain At Least 1 Uppercase letter and 1 Number. Please Try Again!");
    public Label lblPassError2 = new Label("Password Cannot Start With a Number. Please Try Again!");
    public Label lblPassError3 = new Label("New Password Cannot Be The Same As The Old Password. Please Try Again!");
...
//GridPanes
    ...
    public Tab editGuestNameTab = new Tab("Edit Guest Name");
    public Tab editGuestPassTab = new Tab ("Edit Guest Password");
...
//Guest Creation
 ...
 // Employee Booking Pane
    ...
    //edit guest pane
        editGuestPane.setAlignment(Pos.TOP_LEFT);
        ...
        editGuestPane.add(btnReturn, 6, 0);
