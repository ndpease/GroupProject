...
/// Elements for Employee Menu ////
        ...
        //Employee logon scene
        TextField txtEmpLogUsername = new TextField();
        TextField txtEmpLogPassword = new TextField();
        Label lblEmpLogUsername = new Label("Employee Username: ");
        Label lblEmpLogPassword = new Label("Employee Password: ");
        Button btnEmpLogin = new Button("Login");
    
        //Guest logon scene
        TextField txtGuestLogUsername = new TextField();
        TextField txtGuestLogPassword = new TextField();
        Label lblGuestLogUsername = new Label("Guest Username: ");
        Label lblGuestLogPassword = new Label("Guest Password: ");
        Button btnGuestLogin = new Button("Login");
...
/// Elements for Guest Menu ////
        ...
        public GridPane empLogOnPane = new GridPane();
        public GridPane guestLogOnPane = new GridPane();
        ...
        // Scene Creation 
        public Scene empScene = new Scene(empPrimaryPane, 600, 700);
        public Scene logonScene = new Scene(logonPane, 300, 200); 
        public Scene guestScene = new Scene(guestPrimaryPane, 600, 700);
        public Scene newEmpScene = new Scene(newEmployeePane, 500, 400);
        public Scene empLogOnScene = new Scene(empLogOnPane, 500, 400); 
        public Scene guestLogOnScene = new Scene(guestLogOnPane, 500, 400);
    ...
    public void start(Stage primaryStage) {
        ...
        //Employee login pane
        empLogOnPane.setAlignment(Pos.CENTER);
        empLogOnPane.add(lblEmpLogUsername, 0,0);
        empLogOnPane.add(lblEmpLogPassword, 0, 1);
        empLogOnPane.add(txtEmpLogUsername, 1, 0);
        empLogOnPane.add(txtEmpLogPassword, 1, 1);
        empLogOnPane.add(btnEmpLogin, 1, 2);
        
        //Guest login pane
        guestLogOnPane.setAlignment(Pos.CENTER);
        guestLogOnPane.add(lblGuestLogUsername, 0,0);
        guestLogOnPane.add(lblGuestLogPassword, 0, 1);
        guestLogOnPane.add(txtGuestLogUsername, 1, 0);
        guestLogOnPane.add(txtGuestLogPassword, 1, 1);
        guestLogOnPane.add(btnGuestLogin, 1, 2);
        ...
        // Logon Scene Actions
        btnEmpLogon.setOnAction(e -> {primaryStage.setScene(empLogOnScene);});
        btnGuestLogon.setOnAction(e -> {primaryStage.setScene(guestLogOnScene);});
        btnNewEmployee.setOnAction(e -> {primaryStage.setScene(newEmpScene);});
        ...
        btnCreateEmp.setOnAction(e -> {
            ...
            if (bool == true) {
                ...
                newEmployeePane.add(lblexistingName, 3, 3);
            }
            else if (bool == false) {
        ...
        btnGuestLogin.setOnAction(e -> {primaryStage.setScene(guestScene);});
    }
    ...
    public void employeeLogin()
    {
        ...
        String password;
        boolean bool = false;
        username = txtEmpLogUsername.getText();
                password = txtEmpLogPassword.getText();
                for (int i=0; i<Employee.employees.size(); i++) {
