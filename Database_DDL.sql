...
CREATE TABLE ROOM (
	...
	RoomBooked		VARCHAR(10) CHECK(RoomBooked in ('0', '1')),
	BedOption		Numeric(2),
	...
	RoomStatus		VARCHAR(10) CHECK (RoomStatus in ('0', '1'))
);
...
CREATE TABLE ROOM_SERVICE (
	RoomServiceID		Numeric(10) PRIMARY KEY not null,
	RoomServiceDescription	VARCHAR(100),
	RoomServicePrice	Numeric(5,2)
);
